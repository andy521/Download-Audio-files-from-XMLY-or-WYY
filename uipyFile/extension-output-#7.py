...
class Ui_MatWindow(object):
    def setupUi(self, MatWindow):
        ...
        self.line_2.setGeometry(QtCore.QRect(410, 40, 20, 531))
        ...
        self.textBrowser_search = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser_search.setGeometry(QtCore.QRect(20, 150, 371, 391))
        self.textBrowser_search.setObjectName("textBrowser_search")
        ...
        self.textBrowser_download = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser_download.setGeometry(QtCore.QRect(510, 150, 521, 381))
    ...
    def retranslateUi(self, MatWindow):
        ...
        self.lineEdit_Keyword.setText(_translate("MatWindow", "金瓶梅"))
